#! /bin/bash
###This is a placeholder workflow for the beta version of Binsanity2###
...
#########PASS1###############
Binsanity2 -f $location_of_fasta_file -l $fasta -c $coverage_file --checkm_threads $threads  -o PASS1 -m 2000 -v 200  -p -25 --skip-kmeans --refine-preference -50
cd PASS1
...
cd ../PASS2
Binsanity2 -f . -l PASS1_HR_LC_SH.all.fa -c $coverage_file --checkm_threads $threads  -o . -p -15 --skip-kmeans --refine-preference -35
mv BinSanity-Final-bins/*.fna .
rm -r BinSanity-Final-bins
num=1
for file in *.fna; do
...
cd ../PASS3
Binsanity2 -f . -l PASS2_HR_LC_SH.all.fa -c $coverage_file --checkm_threads $threads  -o . -p -5 --skip-kmeans --refine-preference -25
mv BinSanity-Final-bins/*.fna .
rm -r BinSanity-Final-bins
num=1
for file in *.fna; do
...
cd ../PASS4
Binsanity2 -f . -l PASS3_HR_LC_SH.all.fa -c $coverage_file --checkm_threads $threads  -o . -p -3 --skip-kmeans --refine-preference -25
mv BinSanity-Final-bins/*.fna .
rm -r BinSanity-Final-bins
num=1
for file in *.fna; do
...
cd ../
cp PASS*/high_completion/*.fna Binsanity2WF-Final-Genomes
cp PASS4/high_redundancy/*.fna Binsanity2WF-Final-Genomes
cp PASS4/strain_redundancy/*.fna Binsanity2WF-Final-Genomes
cp PASS4/low_completion/*.fna Binsanity2WF-Final-Genomes

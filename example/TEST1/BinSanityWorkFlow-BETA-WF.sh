...
clust2="50"
#########PASS1##############
Binsanity-wf -f $location_of_fasta_file -l $fasta -c $coverage_file --threads $threads -o PASS1 -m 2000 -v 200  -p -25 --refine-preference -50 
cd PASS1
...
cd ../PASS2
Binsanity-wf -f . -l PASS1_HR_LC_SH.all.fa -c $coverage_file --threads $threads -o . -p -15 --refine-preference -35
#cd PASS2
mv BinSanity-Final-bins/*.fna .
rm -r BinSanity-Final-bins
num=1
...
###########PASS3############
cd ../PASS3
Binsanity-wf -f . -l PASS2_HR_LC_SH.all.fa -c $coverage_file --threads $threads -o . -p -10 --refine-preference -25
mv BinSanity-Final-bins/*.fna .
rm -r BinSanity-Final-bins
num=1
for file in *.fna; do
...
cd ../PASS4
Binsanity-wf -f . -l PASS3_HR_LC_SH.all.fa -c $coverage_file --threads $threads -o . -p -5 --refine-preference -25
mv BinSanity-Final-bins/*.fna .
rm -r BinSanity-Final-bins
num=1
for file in *.fna; do
...
##########PASS5#########
cd ../PASS5
Binsanity-wf -f . -l PASS4_HR_LC_SH.all.fa -c $coverage_file --threads $threads -o . -p -3 --refine-preference -25
mv BinSanity-Final-bins/*.fna .
rm -r BinSanity-Final-bins
num=1
for file in *.fna; do
...
################PASS6################
cd ../PASS6
Binsanity-wf -f . -l PASS5_HR_LC_SH.all.fa -c $coverage_file --threads $threads -o . -p -3 --refine-preference -25
mv BinSanity-Final-bins/*.fna .
rm -r BinSanity-Final-bins
num=1
for file in *.fna; do
